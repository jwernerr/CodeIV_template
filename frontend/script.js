...
function register() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    username = (_a = document.getElementById("username")) === null || _a === void 0 ? void 0 : _a.value;
                    password = (_b = document.getElementById("password")) === null || _b === void 0 ? void 0 : _b.value;
...
function login() {
    return __awaiter(this, void 0, void 0, function () {
        var username, password, res, data_1, data, greetingElem, loginFormElem, welcomeElem;
        var _a, _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                ...
                case 4:
                    ...
                    if (data.success) {
                        ...
                        greetingElem = document.getElementById("greeting");
                        if (greetingElem)
                            greetingElem.innerText = "Hello " + currentUser;
                        loginFormElem = document.getElementById("loginForm");
                        if (loginFormElem)
